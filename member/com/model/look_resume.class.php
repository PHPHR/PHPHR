...
class look_resume_controller extends company
{
	function index_action()
	{
		...
		if(is_array($rows))
		{
			...
			$resume=$this->obj->DB_select_alls("resume","resume_expect","a.uid=b.uid and b.`id` in (".pylode(",",$resume_id).")","a.`name`,a.`sex`,a.`exp`,a.`edu`,b.`id`,b.`salary`,b.job_classid");
