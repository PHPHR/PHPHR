...
CREATE DATABASE /*!32312 IF NOT EXISTS*/`phphr` /*!40100 DEFAULT CHARACTER SET gbk */;

USE `phphr`;

/*Table structure for table `phphr_ad` */

DROP TABLE IF EXISTS `phphr_ad`;

CREATE TABLE `phphr_ad` (
...
/*Data for the table `phphr_ad` */

insert  into `phphr_ad`(`id`,`ad_name`,`did`,`time_start`,`time_end`,`ad_type`,`word_info`,`word_url`,`pic_url`,`pic_src`,`pic_width`,`pic_height`,`flash_url`,`flash_src`,`flash_width`,`flash_height`,`class_id`,`is_check`,`is_open`,`target`,`hits`,`remark`,`sort`) values (1,'首页幻灯一','0','2015-06-23','2017-06-30','pic','','','../data/upload/pimg/20150623/14428064404.JPG','http://www.phpyun.com','510','248',NULL,NULL,NULL,NULL,3,1,1,2,1,'',0),(2,'首页专题引导','0','2015-06-23','2017-06-30','pic','','','../data/upload/pimg/20150623/14382350059.JPG','http://www.phpyun.com','','',NULL,NULL,NULL,NULL,51,1,1,2,2,'',0),(3,'首页对联广告右','0','2015-06-23','2017-06-30','pic','','','../data/upload/pimg/20150623/14396433257.JPG','','','',NULL,NULL,NULL,NULL,11,1,1,2,0,'',0),(4,'首页对联广告左','0','2015-06-23','2017-06-30','pic','','','../data/upload/pimg/20150623/14435734889.GIF','','','',NULL,NULL,NULL,NULL,11,1,1,2,0,'',0),(5,'首页头部右侧广告','0','2015-06-23','2017-06-30','pic','','','../data/upload/pimg/20150623/14447101994.GIF','','','',NULL,NULL,NULL,NULL,52,1,1,2,0,'',0),(6,'会员登录页广告','0','2015-06-23','2017-06-30','pic','','','../data/upload/pimg/20150623/14434106119.JPG','','','',NULL,NULL,NULL,NULL,37,1,1,2,1,'',0),(7,'WAP幻灯一','0','2015-06-23','2017-06-30','pic','','','../data/upload/pimg/20150623/14412678513.PNG','','','',NULL,NULL,NULL,NULL,50,1,1,2,0,'',0);

/*Table structure for table `phphr_ad_class` */

DROP TABLE IF EXISTS `phphr_ad_class`;

CREATE TABLE `phphr_ad_class` (
  `id` int(20) NOT NULL AUTO_INCREMENT,
...
/*Data for the table `phphr_adclick` */

insert  into `phphr_adclick`(`id`,`aid`,`uid`,`ip`,`addtime`) values (1,1,0,'192.168.0.50',1438759725),(2,2,0,'192.168.0.77',1438839216),(3,6,0,'192.168.0.50',1438843413);

/*Table structure for table `phphr_admin_announcement` */

DROP TABLE IF EXISTS `phphr_admin_announcement`;

CREATE TABLE `phphr_admin_announcement` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
...
/*Data for the table `phphr_admin_link` */

insert  into `phphr_admin_link`(`id`,`link_name`,`link_url`,`img_type`,`pic`,`link_type`,`link_state`,`link_sorting`,`link_time`,`did`,`tem_type`) values (1,'php云人才系统','http://www.phpyun.com',0,'','1',1,9,'1330695646',0,3),(2,'hr135人才网','http://www.hr135.com',0,'','1',1,1,'1330828266',8,2),(3,'php云论坛','http://www.phpyun.com/bbs',0,'','1',1,0,'1356609401',8,3),(4,'www.phpyun.com','http://www.phpyun.com',1,'data/upload/link/20140523/14072507114.JPG','2',1,0,'1375926679',0,1);

/*Table structure for table `phphr_admin_log` */

DROP TABLE IF EXISTS `phphr_admin_log`;

CREATE TABLE `phphr_admin_log` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `uid` int(11) DEFAULT NULL,
...
/*Data for the table `phphr_admin_log` */

/*Table structure for table `phphr_admin_navigation` */

DROP TABLE IF EXISTS `phphr_admin_navigation`;

CREATE TABLE `phphr_admin_navigation` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
...
/*Data for the table `phphr_admin_template` */

/*Table structure for table `phphr_admin_user` */

DROP TABLE IF EXISTS `phphr_admin_user`;

CREATE TABLE `phphr_admin_user` (
...
/*Data for the table `phphr_admin_user` */

insert  into `phphr_admin_user`(`uid`,`m_id`,`username`,`password`,`name`,`did`,`lasttime`) values (1,1,'admin','21232f297a57a5a743894a0e4a801fc3','超级管理员',0,1438913898);

/*Table structure for table `phphr_admin_user_group` */

DROP TABLE IF EXISTS `phphr_admin_user_group`;

CREATE TABLE `phphr_admin_user_group` (
...
/*Data for the table `phphr_answer` */

/*Table structure for table `phphr_answer_review` */

DROP TABLE IF EXISTS `phphr_answer_review`;

CREATE TABLE `phphr_answer_review` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `aid` int(11) NOT NULL,
...
/*Data for the table `phphr_answer_review` */

/*Table structure for table `phphr_atn` */

DROP TABLE IF EXISTS `phphr_atn`;

CREATE TABLE `phphr_atn` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `uid` int(11) NOT NULL,
...
/*Data for the table `phphr_atn` */

/*Table structure for table `phphr_attention` */

DROP TABLE IF EXISTS `phphr_attention`;

CREATE TABLE `phphr_attention` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `ids` text NOT NULL,
...
/*Data for the table `phphr_attention` */

/*Table structure for table `phphr_bank` */

DROP TABLE IF EXISTS `phphr_bank`;

CREATE TABLE `phphr_bank` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
...
/*Data for the table `phphr_bank` */

/*Table structure for table `phphr_banner` */

DROP TABLE IF EXISTS `phphr_banner`;

CREATE TABLE `phphr_banner` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `uid` int(11) DEFAULT NULL,
...
/*Data for the table `phphr_banner` */

/*Table structure for table `phphr_blacklist` */

DROP TABLE IF EXISTS `phphr_blacklist`;

CREATE TABLE `phphr_blacklist` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
...
/*Data for the table `phphr_blacklist` */

/*Table structure for table `phphr_change` */

DROP TABLE IF EXISTS `phphr_change`;

CREATE TABLE `phphr_change` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `uid` int(11) DEFAULT NULL,
...
/*Data for the table `phphr_change` */

/*Table structure for table `phphr_city_class` */

DROP TABLE IF EXISTS `phphr_city_class`;

CREATE TABLE `phphr_city_class` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
...
/*Data for the table `phphr_company` */

insert  into `phphr_company`(`uid`,`name`,`hy`,`pr`,`provinceid`,`cityid`,`mun`,`sdate`,`money`,`content`,`address`,`zip`,`linkman`,`linkjob`,`linkqq`,`linkphone`,`linktel`,`linkmail`,`website`,`x`,`y`,`logo`,`payd`,`integral`,`lastupdate`,`cloudtype`,`jobtime`,`r_status`,`firmpic`,`rec`,`hits`,`ant_num`,`pl_time`,`pl_status`,`order`,`admin_remark`,`email_dy`,`msg_dy`,`sync`,`hy_dy`,`moblie_status`,`email_status`,`yyzz_status`,`hottime`,`did`) values (3,'',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,'',NULL,'',NULL,NULL,NULL,'','',NULL,NULL,NULL,NULL,0,0,NULL,NULL,NULL,0,NULL,0,0,0,NULL,1,0,NULL,0,0,0,NULL,0,0,0,0,NULL);

/*Table structure for table `phphr_company_cert` */

DROP TABLE IF EXISTS `phphr_company_cert`;

CREATE TABLE `phphr_company_cert` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `uid` int(11) DEFAULT NULL,
...
/*Data for the table `phphr_company_cert` */

/*Table structure for table `phphr_company_job` */

DROP TABLE IF EXISTS `phphr_company_job`;

CREATE TABLE `phphr_company_job` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `uid` int(11) NOT NULL,
  `name` varchar(50) NOT NULL,
  `hy` int(5) DEFAULT NULL,
...
/*Data for the table `phphr_company_job` */

/*Table structure for table `phphr_company_job_link` */

DROP TABLE IF EXISTS `phphr_company_job_link`;

CREATE TABLE `phphr_company_job_link` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `uid` int(11) DEFAULT NULL,
...
/*Data for the table `phphr_company_job_link` */

/*Table structure for table `phphr_company_msg` */

DROP TABLE IF EXISTS `phphr_company_msg`;

CREATE TABLE `phphr_company_msg` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `uid` int(11) DEFAULT NULL,
...
/*Data for the table `phphr_company_msg` */

/*Table structure for table `phphr_company_news` */

DROP TABLE IF EXISTS `phphr_company_news`;

CREATE TABLE `phphr_company_news` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
...
/*Data for the table `phphr_company_news` */

/*Table structure for table `phphr_company_order` */

DROP TABLE IF EXISTS `phphr_company_order`;

CREATE TABLE `phphr_company_order` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `uid` int(11) NOT NULL,
...
/*Data for the table `phphr_company_order` */

/*Table structure for table `phphr_company_pay` */

DROP TABLE IF EXISTS `phphr_company_pay`;

CREATE TABLE `phphr_company_pay` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `order_id` varchar(18) DEFAULT NULL,
...
/*Data for the table `phphr_company_pay` */

insert  into `phphr_company_pay`(`id`,`order_id`,`order_price`,`pay_time`,`pay_state`,`com_id`,`pay_remark`,`type`,`pay_type`,`did`) values (1,'143876554022008','10.00',1438765540,2,1,'注册赠送',1,23,NULL),(2,'143876557643665','10.00',1438765576,2,2,'注册赠送',1,23,NULL),(3,'143884082442851','10.00',1438840824,2,3,'注锟斤拷锟斤拷锟斤拷',1,23,NULL),(4,'143884342788780','1.00',1438843427,2,1,'会员登录',1,0,0),(5,'143884437913803','1.00',1438844379,2,3,'会员登录',1,0,0),(6,'143885690956648','1.00',1438856909,2,2,'会员登录',1,0,0),(7,'143885699831555','2.00',1438856998,2,2,'发布简历',1,0,0),(8,'143885843335314','5.00',1438858433,2,2,'上传头像',1,0,0),(9,'143890948483530','1.00',1438909484,2,2,'会员登录',1,0,0);

/*Table structure for table `phphr_company_product` */

DROP TABLE IF EXISTS `phphr_company_product`;

CREATE TABLE `phphr_company_product` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `uid` int(11) DEFAULT '0',
  `title` varchar(200) DEFAULT '0',
...
/*Data for the table `phphr_company_product` */

/*Table structure for table `phphr_company_rating` */

DROP TABLE IF EXISTS `phphr_company_rating`;

CREATE TABLE `phphr_company_rating` (
...
/*Data for the table `phphr_company_show` */

/*Table structure for table `phphr_company_statis` */

DROP TABLE IF EXISTS `phphr_company_statis`;

CREATE TABLE `phphr_company_statis` (
  `uid` int(11) NOT NULL,
...
/*Data for the table `phphr_company_statis` */

insert  into `phphr_company_statis`(`uid`,`pay`,`integral`,`sq_job`,`fav_job`,`rating`,`rating_name`,`vip_etime`,`all_pay`,`consum_pay`,`rating_type`,`invite_resume`,`comtpl`,`comtpl_all`,`job_num`,`editjob_num`,`breakjob_num`,`down_resume`,`qqshow`,`qqcomment`,`sinashare`,`sinashow`,`sinacomment`,`qqwname`,`sinawname`,`lt_job_num`,`lt_editjob_num`,`lt_breakjob_num`,`lt_down_resume`,`qqshare`,`msg_num`,`autotime`,`vip_stime`,`did`) values (3,0.00,'11',0,0,3,'免费会员','0',0.00,0.00,1,10,'0',NULL,3,1,2,5,0,0,0,0,0,NULL,NULL,0,0,0,0,0,0,0,0,NULL);

/*Table structure for table `phphr_company_tpl` */

DROP TABLE IF EXISTS `phphr_company_tpl`;

CREATE TABLE `phphr_company_tpl` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
...
/*Data for the table `phphr_company_tpl` */

insert  into `phphr_company_tpl`(`id`,`name`,`url`,`pic`,`type`,`price`,`status`,`service_uid`) values (4,'默认模板','default','data/upload/company/20150606/make_S_14434103463.JPG',0,'0',1,'0'),(6,'扁平模板','blue','data/upload/company/20141218/make_S_14285802996.PNG',1,'5',1,'0'),(7,'时尚大气模板','green','data/upload/company/20150606/make_S_14386895355.JPG',1,'20',1,'0'),(10,'企业模板','white','data/upload/company/20150606/make_S_14354641321.JPG',1,'11',1,'0');

/*Table structure for table `phphr_coupon` */

DROP TABLE IF EXISTS `phphr_coupon`;

CREATE TABLE `phphr_coupon` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
...
/*Data for the table `phphr_coupon` */

/*Table structure for table `phphr_coupon_list` */

DROP TABLE IF EXISTS `phphr_coupon_list`;

CREATE TABLE `phphr_coupon_list` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `uid` int(11) DEFAULT NULL,
...
/*Data for the table `phphr_coupon_list` */

/*Table structure for table `phphr_cron` */

DROP TABLE IF EXISTS `phphr_cron`;

CREATE TABLE `phphr_cron` (
...
/*Data for the table `phphr_cron` */

/*Table structure for table `phphr_desc_class` */

DROP TABLE IF EXISTS `phphr_desc_class`;

CREATE TABLE `phphr_desc_class` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `name` varchar(50) NOT NULL,
  `sort` int(11) DEFAULT '0',
  PRIMARY KEY (`id`)
...
/*Data for the table `phphr_desc_class` */

insert  into `phphr_desc_class`(`id`,`name`,`sort`) values (1,'关于我们',1),(2,'支付信息',2),(3,'网站特色',3),(4,'咨询反馈',4),(5,'特色服务',5);

/*Table structure for table `phphr_description` */

DROP TABLE IF EXISTS `phphr_description`;

CREATE TABLE `phphr_description` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
...
/*Data for the table `phphr_domain` */

/*Table structure for table `phphr_down_resume` */

DROP TABLE IF EXISTS `phphr_down_resume`;

CREATE TABLE `phphr_down_resume` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `uid` int(11) DEFAULT NULL,
...
/*Data for the table `phphr_down_resume` */

/*Table structure for table `phphr_email_msg` */

DROP TABLE IF EXISTS `phphr_email_msg`;

CREATE TABLE `phphr_email_msg` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `uid` int(11) DEFAULT NULL,
...
/*Data for the table `phphr_email_msg` */

/*Table structure for table `phphr_entrust` */

DROP TABLE IF EXISTS `phphr_entrust`;

CREATE TABLE `phphr_entrust` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `uid` int(11) DEFAULT NULL,
...
/*Data for the table `phphr_entrust` */

/*Table structure for table `phphr_evaluate` */

DROP TABLE IF EXISTS `phphr_evaluate`;

CREATE TABLE `phphr_evaluate` (
...
/*Data for the table `phphr_evaluate` */

/*Table structure for table `phphr_evaluate_group` */

DROP TABLE IF EXISTS `phphr_evaluate_group`;

CREATE TABLE `phphr_evaluate_group` (
  `id` int(4) NOT NULL AUTO_INCREMENT,
...
/*Data for the table `phphr_evaluate_group` */

/*Table structure for table `phphr_evaluate_leave_message` */

DROP TABLE IF EXISTS `phphr_evaluate_leave_message`;

CREATE TABLE `phphr_evaluate_leave_message` (
...
/*Data for the table `phphr_evaluate_leave_message` */

/*Table structure for table `phphr_evaluate_log` */

DROP TABLE IF EXISTS `phphr_evaluate_log`;

CREATE TABLE `phphr_evaluate_log` (
  `id` int(4) NOT NULL AUTO_INCREMENT,
...
/*Data for the table `phphr_evaluate_log` */

/*Table structure for table `phphr_excel` */

DROP TABLE IF EXISTS `phphr_excel`;

CREATE TABLE `phphr_excel` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `name` varchar(255) NOT NULL,
...
/*Data for the table `phphr_excel` */

/*Table structure for table `phphr_fav_job` */

DROP TABLE IF EXISTS `phphr_fav_job`;

CREATE TABLE `phphr_fav_job` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `uid` int(11) NOT NULL,
...
/*Data for the table `phphr_fav_job` */

/*Table structure for table `phphr_finder` */

DROP TABLE IF EXISTS `phphr_finder`;

CREATE TABLE `phphr_finder` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `uid` int(11) DEFAULT NULL,
  `usertype` int(1) DEFAULT NULL,
  `name` varchar(100) DEFAULT NULL,
...
/*Data for the table `phphr_finder` */

/*Table structure for table `phphr_friend` */

DROP TABLE IF EXISTS `phphr_friend`;

CREATE TABLE `phphr_friend` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `uid` int(11) DEFAULT NULL,
  `nid` int(11) DEFAULT NULL,
...
/*Data for the table `phphr_friend` */

/*Table structure for table `phphr_friend_foot` */

DROP TABLE IF EXISTS `phphr_friend_foot`;

CREATE TABLE `phphr_friend_foot` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `uid` int(11) DEFAULT NULL,
...
/*Data for the table `phphr_friend_foot` */

/*Table structure for table `phphr_friend_im_list` */

DROP TABLE IF EXISTS `phphr_friend_im_list`;

CREATE TABLE `phphr_friend_im_list` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `uid` int(11) DEFAULT NULL,
...
/*Data for the table `phphr_friend_im_list` */

/*Table structure for table `phphr_friend_info` */

DROP TABLE IF EXISTS `phphr_friend_info`;

CREATE TABLE `phphr_friend_info` (
  `uid` int(11) DEFAULT NULL,
...
/*Data for the table `phphr_friend_info` */

insert  into `phphr_friend_info`(`uid`,`nickname`,`sex`,`pic`,`pic_big`,`description`,`fans`,`atnnum`,`ask`,`answer`,`birthday`,`usertype`,`iscert`,`did`) values (1,'tao',3,NULL,NULL,NULL,0,0,0,0,NULL,1,0,NULL),(2,'test',3,NULL,NULL,NULL,0,0,0,0,NULL,1,0,NULL),(3,'company',3,NULL,NULL,NULL,0,0,0,0,NULL,2,0,NULL);

/*Table structure for table `phphr_friend_message` */

DROP TABLE IF EXISTS `phphr_friend_message`;

CREATE TABLE `phphr_friend_message` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `pid` int(11) NOT NULL,
  `uid` int(11) DEFAULT NULL,
...
/*Data for the table `phphr_friend_message` */

/*Table structure for table `phphr_friend_reply` */

DROP TABLE IF EXISTS `phphr_friend_reply`;

CREATE TABLE `phphr_friend_reply` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `nid` int(11) DEFAULT NULL,
  `fid` int(11) DEFAULT NULL,
  `uid` int(11) DEFAULT NULL,
...
/*Data for the table `phphr_friend_reply` */

/*Table structure for table `phphr_friend_state` */

DROP TABLE IF EXISTS `phphr_friend_state`;

CREATE TABLE `phphr_friend_state` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `uid` int(11) DEFAULT NULL,
  `content` varchar(225) CHARACTER SET gbk COLLATE gbk_bin DEFAULT NULL,
  `ctime` int(11) DEFAULT NULL,
...
/*Data for the table `phphr_friend_state` */

insert  into `phphr_friend_state`(`id`,`uid`,`content`,`ctime`,`type`,`msg_pic`) values (1,2,'发布了 <a href=\"http://www.phphr.com/resume/index.php?c=show&id=1\" target=\"_blank\">新简历</a>。',1438856998,2,NULL);

/*Table structure for table `phphr_hot_key` */

DROP TABLE IF EXISTS `phphr_hot_key`;

CREATE TABLE `phphr_hot_key` (
  `id` int(20) NOT NULL AUTO_INCREMENT,
...
/*Data for the table `phphr_hot_key` */

/*Table structure for table `phphr_hotjob` */

DROP TABLE IF EXISTS `phphr_hotjob`;

CREATE TABLE `phphr_hotjob` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `uid` int(11) DEFAULT NULL,
  `username` varchar(200) DEFAULT NULL,
...
/*Data for the table `phphr_hotjob` */

/*Table structure for table `phphr_industry` */

DROP TABLE IF EXISTS `phphr_industry`;

CREATE TABLE `phphr_industry` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `name` varchar(50) NOT NULL,
  `sort` int(11) DEFAULT '0',
  PRIMARY KEY (`id`)
...
/*Data for the table `phphr_industry` */

insert  into `phphr_industry`(`id`,`name`,`sort`) values (35,'计算机/互联网',6),(36,'销售/客服/技术支持',0),(37,'会计/金融/银行/保险',0),(38,'生产/营运/采购/物流',0),(39,'生物/制药/医疗/护理',0),(40,'广告/市场/媒体/艺术',0),(41,'建筑/房地产',0),(42,'人事/行政/高级管理',0),(43,'咨询/法律/教育/科研',0),(44,'服务业',0),(45,'公务员/翻译/其他',1),(836,'化工/能源',1),(835,'贸易/百货',2),(837,'机械/设备/技工',2),(839,'通信/电子',0);

/*Table structure for table `phphr_invoice_record` */

DROP TABLE IF EXISTS `phphr_invoice_record`;

CREATE TABLE `phphr_invoice_record` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
...
/*Data for the table `phphr_invoice_record` */

/*Table structure for table `phphr_job_class` */

DROP TABLE IF EXISTS `phphr_job_class`;

CREATE TABLE `phphr_job_class` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `keyid` int(11) NOT NULL,
  `name` varchar(50) NOT NULL,
...
/*Data for the table `phphr_look_job` */

/*Table structure for table `phphr_look_resume` */

DROP TABLE IF EXISTS `phphr_look_resume`;

CREATE TABLE `phphr_look_resume` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `uid` int(11) DEFAULT NULL,
  `com_id` int(11) DEFAULT NULL,
...
/*Data for the table `phphr_look_resume` */

/*Table structure for table `phphr_member` */

DROP TABLE IF EXISTS `phphr_member`;

CREATE TABLE `phphr_member` (
  ...
  `did` int(11) DEFAULT NULL,
  PRIMARY KEY (`uid`)
) ENGINE=MyISAM AUTO_INCREMENT=4 DEFAULT CHARSET=gbk COMMENT='用户成员表（个人用户、企业用户）';

/*Data for the table `phphr_member` */

insert  into `phphr_member`(`uid`,`username`,`password`,`email`,`moblie`,`reg_ip`,`reg_date`,`login_ip`,`login_date`,`usertype`,`login_hits`,`salt`,`address`,`name_repeat`,`qqid`,`status`,`pwuid`,`pw_repeat`,`lock_info`,`email_status`,`signature`,`sinaid`,`wxid`,`wxopenid`,`unionid`,`wxname`,`wxbindtime`,`passtext`,`source`,`regcode`,`did`) values (1,'tao','dae2901d5b03326496ff3527b490e174','','','192.168.0.50',1438765540,'192.168.0.50',1438844210,1,0,'4405ca',NULL,0,'',1,0,0,NULL,NULL,NULL,'','',NULL,NULL,NULL,0,NULL,1,0,NULL),(2,'test','db6a845b0aad3a00b3c997f6f0b7c585','test@qq.com','13800138000','192.168.0.50',1438765576,'192.168.0.44',1438909484,1,0,'8a72ad',NULL,0,'',1,0,0,NULL,NULL,NULL,'','',NULL,NULL,NULL,0,NULL,1,0,NULL),(3,'company','7e4f198d42d048b643cebd4015232fa0','','','192.168.0.50',1438840824,'192.168.0.50',1438844379,2,0,'8a127b',NULL,0,'',1,0,0,NULL,NULL,NULL,'','',NULL,NULL,NULL,0,NULL,1,0,NULL);

/*Table structure for table `phphr_member_log` */

DROP TABLE IF EXISTS `phphr_member_log`;

CREATE TABLE `phphr_member_log` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `uid` int(11) DEFAULT NULL,
  ...
  `ctime` int(11) DEFAULT NULL,
  PRIMARY KEY (`id`)
) ENGINE=MyISAM AUTO_INCREMENT=4 DEFAULT CHARSET=gbk COMMENT='会员日志';

/*Data for the table `phphr_member_log` */

insert  into `phphr_member_log`(`id`,`uid`,`opera`,`type`,`usertype`,`content`,`ip`,`ctime`) values (1,2,2,1,1,'创建一份简历','192.168.0.44',1438856998),(2,2,7,0,1,'修改基本信息','192.168.0.44',1438858369),(3,2,0,0,1,'上传头像','192.168.0.44',1438858433);

/*Table structure for table `phphr_member_statis` */

DROP TABLE IF EXISTS `phphr_member_statis`;

CREATE TABLE `phphr_member_statis` (
  `uid` int(11) NOT NULL,
  `integral` varchar(10) NOT NULL DEFAULT '0',
  `pay` double(10,2) NOT NULL DEFAULT '0.00',
...
/*Data for the table `phphr_member_statis` */

insert  into `phphr_member_statis`(`uid`,`integral`,`pay`,`resume_num`,`fav_jobnum`,`sq_jobnum`,`message_num`,`down_num`) values (1,'11',0.00,0,0,0,0,0),(2,'19',0.00,1,0,0,0,0);

/*Table structure for table `phphr_message` */

DROP TABLE IF EXISTS `phphr_message`;
...
/*Data for the table `phphr_message` */

/*Table structure for table `phphr_moblie_msg` */

DROP TABLE IF EXISTS `phphr_moblie_msg`;

CREATE TABLE `phphr_moblie_msg` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `uid` int(11) DEFAULT NULL,
  `name` varchar(100) DEFAULT NULL,
  `cuid` int(11) DEFAULT NULL,
...
/*Data for the table `phphr_moblie_msg` */

/*Table structure for table `phphr_msg` */

DROP TABLE IF EXISTS `phphr_msg`;

CREATE TABLE `phphr_msg` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `uid` int(11) DEFAULT NULL,
  `username` varchar(100) DEFAULT NULL,
  `jobid` int(11) DEFAULT NULL,
...
/*Data for the table `phphr_msg` */

/*Table structure for table `phphr_navigation` */

DROP TABLE IF EXISTS `phphr_navigation`;

CREATE TABLE `phphr_navigation` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `nid` int(11) NOT NULL,
  `name` varchar(100) NOT NULL,
...
/*Data for the table `phphr_navigation` */

insert  into `phphr_navigation`(`id`,`nid`,`name`,`url`,`sort`,`display`,`eject`,`type`,`furl`,`color`,`model`,`bold`,`desc`) values (1,1,'首页','index.php',1,1,0,1,'','','',1,NULL),(2,1,'找工作','job/',2,1,0,1,'','','',1,NULL),(3,1,'找人才','resume/',3,1,0,1,'','','',0,NULL),(4,1,'职场资讯','article/',7,1,0,1,'article/','','',0,NULL),(5,1,'微招聘','once/',6,1,0,1,'','','',0,NULL),(6,2,'注册协议','/about/service.html',98,1,1,1,NULL,NULL,NULL,NULL,NULL),(7,2,'关于我们','/about/about.html',54,1,1,1,NULL,NULL,NULL,NULL,NULL),(8,3,'关于我们','/about/about.html',99,1,0,1,NULL,NULL,NULL,NULL,NULL),(9,3,'首页','index.php',55,1,0,1,NULL,NULL,NULL,NULL,NULL),(17,1,'地图','map/',10,1,1,1,'','','',0,NULL),(11,1,'找企业','company/',4,1,0,1,'','','',0,NULL),(19,4,'首页','/lietou/',11,1,0,1,'','','',0,NULL),(15,1,'招聘会','zph/',9,1,0,1,'','','',0,NULL),(45,1,'测评','evaluate/',11,1,0,1,'','','',0,NULL),(33,5,'首页','index.php',1,0,1,1,'index.html','','',0,NULL),(23,4,'职场问答','ask/',15,1,0,1,'',NULL,NULL,NULL,NULL),(24,4,'人才网首页','/index.php',16,1,0,1,'',NULL,NULL,NULL,NULL),(32,5,'职场问答','ask/',4,1,1,1,'','','',0,NULL),(26,1,'微简历','tiny/',6,1,0,1,'','','',0,NULL),(34,2,'法律声明','/about/phpyun.html',3,1,0,1,NULL,NULL,NULL,NULL,NULL),(49,11,'触屏版','index.php?c=wap',1,1,1,1,'c_wap.html','','',0,NULL),(51,11,'微信','index.php?c=weixin',3,1,1,1,'c_weixin.html','','',0,NULL);

/*Table structure for table `phphr_navigation_type` */

DROP TABLE IF EXISTS `phphr_navigation_type`;

CREATE TABLE `phphr_navigation_type` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `typename` varchar(100) NOT NULL,
  PRIMARY KEY (`id`)
) ENGINE=MyISAM AUTO_INCREMENT=12 DEFAULT CHARSET=gbk;

/*Data for the table `phphr_navigation_type` */

insert  into `phphr_navigation_type`(`id`,`typename`) values (1,'头部导航'),(2,'底部导航'),(3,'企业底部导航'),(5,'问答模块导航'),(11,'底部客户端导航');

/*Table structure for table `phphr_navmap` */

DROP TABLE IF EXISTS `phphr_navmap`;

CREATE TABLE `phphr_navmap` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `nid` int(11) NOT NULL,
  `name` varchar(100) NOT NULL,
  `url` varchar(100) DEFAULT NULL,
...
/*Data for the table `phphr_news_base` */

/*Table structure for table `phphr_news_content` */

DROP TABLE IF EXISTS `phphr_news_content`;

CREATE TABLE `phphr_news_content` (
...
/*Data for the table `phphr_news_content` */

/*Table structure for table `phphr_news_group` */

DROP TABLE IF EXISTS `phphr_news_group`;

CREATE TABLE `phphr_news_group` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `keyid` int(11) NOT NULL,
  `name` varchar(100) NOT NULL,
  `sort` int(11) DEFAULT '0',
...
/*Data for the table `phphr_once_job` */

/*Table structure for table `phphr_outside` */

DROP TABLE IF EXISTS `phphr_outside`;

CREATE TABLE `phphr_outside` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `name` varchar(100) DEFAULT NULL,
...
/*Data for the table `phphr_outside` */

/*Table structure for table `phphr_prepaid_card` */

DROP TABLE IF EXISTS `phphr_prepaid_card`;

CREATE TABLE `phphr_prepaid_card` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
...
/*Data for the table `phphr_prepaid_card` */

/*Table structure for table `phphr_property` */

DROP TABLE IF EXISTS `phphr_property`;

CREATE TABLE `phphr_property` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `name` varchar(20) DEFAULT NULL,
...
/*Data for the table `phphr_property` */

insert  into `phphr_property`(`id`,`name`,`value`) values (29,'首页推荐','indextj'),(16,'头条','t'),(28,'推荐','tj');

/*Table structure for table `phphr_q_class` */

DROP TABLE IF EXISTS `phphr_q_class`;

CREATE TABLE `phphr_q_class` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `name` varchar(100) NOT NULL,
  `pid` int(11) NOT NULL,
  `pic` varchar(100) DEFAULT NULL,
...
/*Data for the table `phphr_question` */

/*Table structure for table `phphr_reason` */

DROP TABLE IF EXISTS `phphr_reason`;

CREATE TABLE `phphr_reason` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `name` varchar(100) NOT NULL,
  PRIMARY KEY (`id`)
) ENGINE=MyISAM AUTO_INCREMENT=8 DEFAULT CHARSET=gbk;

/*Data for the table `phphr_reason` */

insert  into `phphr_reason`(`id`,`name`) values (1,'非建设性提问'),(2,'不友善言论、垃圾内容与不适宜讨论的内容'),(3,'不构成提问或问题表意不明确'),(4,'问题已失效或过期'),(5,'广告等垃圾信息'),(6,'违法违规内容'),(7,'不宜公开讨论的政治内容');

/*Table structure for table `phphr_rebates` */

DROP TABLE IF EXISTS `phphr_rebates`;

CREATE TABLE `phphr_rebates` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `uid` int(11) DEFAULT NULL,
  `job_uid` int(11) DEFAULT NULL,
  `job_id` int(11) DEFAULT NULL,
...
/*Data for the table `phphr_rebates` */

/*Table structure for table `phphr_recycle` */

DROP TABLE IF EXISTS `phphr_recycle`;

CREATE TABLE `phphr_recycle` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  ...
  `ctime` int(11) DEFAULT NULL,
  PRIMARY KEY (`id`)
) ENGINE=MyISAM DEFAULT CHARSET=gbk COMMENT='回收站';

/*Data for the table `phphr_recycle` */

/*Table structure for table `phphr_report` */

DROP TABLE IF EXISTS `phphr_report`;

CREATE TABLE `phphr_report` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `p_uid` int(11) DEFAULT NULL,
  `c_uid` int(11) DEFAULT NULL,
  `eid` int(11) DEFAULT NULL,
...
/*Data for the table `phphr_report` */

/*Table structure for table `phphr_resume` */

DROP TABLE IF EXISTS `phphr_resume`;

CREATE TABLE `phphr_resume` (
  `uid` int(11) NOT NULL,
  `name` varchar(25) DEFAULT NULL,
...
/*Data for the table `phphr_resume` */

insert  into `phphr_resume`(`uid`,`name`,`sex`,`birthday`,`marriage`,`height`,`nationality`,`weight`,`idcard`,`telphone`,`telhome`,`email`,`edu`,`homepage`,`address`,`description`,`resume_photo`,`photo`,`expect`,`def_job`,`exp`,`status`,`idcard_pic`,`email_status`,`moblie_status`,`idcard_status`,`statusbody`,`cert_time`,`r_status`,`ant_num`,`email_dy`,`msg_dy`,`living`,`domicile`,`basic_info`,`hy_dy`,`info_status`,`did`) values (1,'',NULL,NULL,NULL,NULL,NULL,NULL,NULL,'',NULL,'',NULL,NULL,NULL,NULL,NULL,NULL,0,0,NULL,1,NULL,0,0,0,NULL,NULL,0,0,0,0,NULL,NULL,1,NULL,1,NULL),(2,'吴广德',6,'1988-08-08',8,'200','你猜','1111',NULL,'13800138000','123123123','test@qq.com',9,'个人主页/博客','详细地址','我非常非常的帅, 搞到全世界都嫉妒我, 我觉得我帅也是天生的, 他们嫉妒我是不应该的','./data/upload/user/20150806/1438858433650_1.JPG','./data/upload/user/20150806/1438858433342_2.JPG',0,1,112,1,NULL,0,0,0,NULL,NULL,0,0,0,0,'非洲','户籍所在地',1,NULL,1,NULL);

/*Table structure for table `phphr_resume_cert` */

DROP TABLE IF EXISTS `phphr_resume_cert`;

CREATE TABLE `phphr_resume_cert` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `uid` int(11) NOT NULL,
  `eid` int(11) NOT NULL,
...
/*Data for the table `phphr_resume_cert` */

insert  into `phphr_resume_cert`(`id`,`uid`,`eid`,`name`,`sdate`,`edate`,`title`,`content`) values (1,2,1,'IT证书',1438617600,NULL,'IBM','没有技术含量\n没有人够我帅\n你条毛'),(2,2,1,'EN证书',1440000000,NULL,'IELTS','我帅\n我型,我自豪');

/*Table structure for table `phphr_resume_doc` */

DROP TABLE IF EXISTS `phphr_resume_doc`;

CREATE TABLE `phphr_resume_doc` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `uid` int(11) NOT NULL,
  `eid` int(11) NOT NULL,
  `doc` text,
...
/*Data for the table `phphr_resume_doc` */

/*Table structure for table `phphr_resume_edu` */

DROP TABLE IF EXISTS `phphr_resume_edu`;

CREATE TABLE `phphr_resume_edu` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `uid` int(11) NOT NULL,
  `eid` int(11) NOT NULL,
  `name` varchar(25) NOT NULL,
...
/*Data for the table `phphr_resume_edu` */

insert  into `phphr_resume_edu`(`id`,`uid`,`eid`,`name`,`sdate`,`edate`,`specialty`,`title`,`content`) values (1,2,1,'非洲大学',1438531200,1440604800,'计算机','学生','没什么专业可言'),(2,2,1,'昨天大学',1438704000,1440777600,'计算鸡','老师','非常专业');

/*Table structure for table `phphr_resume_expect` */

DROP TABLE IF EXISTS `phphr_resume_expect`;

CREATE TABLE `phphr_resume_expect` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `uid` int(11) NOT NULL,
  `name` varchar(25) DEFAULT NULL,
  `hy` int(5) DEFAULT NULL,
...
/*Data for the table `phphr_resume_expect` */

insert  into `phphr_resume_expect`(`id`,`uid`,`name`,`hy`,`job_classid`,`provinceid`,`cityid`,`three_cityid`,`salary`,`jobstatus`,`type`,`report`,`defaults`,`open`,`is_entrust`,`full`,`doc`,`hits`,`lastupdate`,`def_job`,`cloudtype`,`olduid`,`integrity`,`height_status`,`statusbody`,`status_time`,`rec`,`top`,`topdate`,`rec_resume`,`dom_sort`,`resume_diy`,`source`,`tmpid`,`ctime`,`dnum`,`did`,`uname`,`idcard_status`,`status`,`r_status`,`edu`,`exp`,`sex`,`photo`,`birthday`) values (1,2,'飞机师',837,'46',2,52,501,38,115,58,46,1,1,0,0,0,38,1438856998,NULL,NULL,NULL,100,0,NULL,NULL,0,NULL,0,NULL,'m0,m1,m2,m4,m5,m6,undefined',NULL,1,NULL,1438856998,0,NULL,'吴广德',0,1,0,9,112,6,'./data/upload/user/20150806/1438858433342_2.JPG','1988-08-08');

/*Table structure for table `phphr_resume_other` */

DROP TABLE IF EXISTS `phphr_resume_other`;

CREATE TABLE `phphr_resume_other` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `uid` int(11) NOT NULL,
  `eid` int(11) NOT NULL,
  `title` varchar(50) DEFAULT NULL,
...
/*Data for the table `phphr_resume_other` */

insert  into `phphr_resume_other`(`id`,`uid`,`eid`,`title`,`content`) values (1,2,1,'我很丑','可是我很温柔');

/*Table structure for table `phphr_resume_project` */

DROP TABLE IF EXISTS `phphr_resume_project`;

CREATE TABLE `phphr_resume_project` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `uid` int(11) NOT NULL,
  `eid` int(11) NOT NULL,
  `name` varchar(25) NOT NULL,
...
/*Data for the table `phphr_resume_project` */

insert  into `phphr_resume_project`(`id`,`uid`,`eid`,`name`,`sdate`,`edate`,`sys`,`title`,`content`) values (1,2,1,'母鸡生蛋',1437926400,1440777600,'环境不好','职位打杂','没有内容没有内容没有内容没有内容没有内容没有内容没有内容没有内容没有内容没有内容没有内容没有内容'),(2,2,1,'不鸟你',1430841600,1441468800,'你老板','你妹','1 .没有内容没有内容没有内容没有内容没有内容没有\n2. 内容没有内容没有内容没有内容没有内容没有内容没有内容没有内容没有内容没有内容没有内容');

/*Table structure for table `phphr_resume_show` */

DROP TABLE IF EXISTS `phphr_resume_show`;

CREATE TABLE `phphr_resume_show` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `title` varchar(200) CHARACTER SET gbk COLLATE gbk_bin DEFAULT NULL,
  `picurl` varchar(200) CHARACTER SET gbk COLLATE gbk_bin DEFAULT NULL,
  `ctime` varchar(200) CHARACTER SET gbk COLLATE gbk_bin DEFAULT NULL,
...
/*Data for the table `phphr_resume_show` */

/*Table structure for table `phphr_resume_skill` */

DROP TABLE IF EXISTS `phphr_resume_skill`;

CREATE TABLE `phphr_resume_skill` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `uid` int(11) NOT NULL,
  `eid` int(11) NOT NULL,
  `name` varchar(25) NOT NULL,
...
/*Data for the table `phphr_resume_skill` */

insert  into `phphr_resume_skill`(`id`,`uid`,`eid`,`name`,`skill`,`ing`,`longtime`) values (1,2,1,'英语',26,43,100),(2,2,1,'C语言',27,43,3);

/*Table structure for table `phphr_resume_tiny` */

DROP TABLE IF EXISTS `phphr_resume_tiny`;

CREATE TABLE `phphr_resume_tiny` (
...
/*Data for the table `phphr_resume_tiny` */

/*Table structure for table `phphr_resume_training` */

DROP TABLE IF EXISTS `phphr_resume_training`;

CREATE TABLE `phphr_resume_training` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `uid` int(11) NOT NULL,
  `eid` int(11) NOT NULL,
  `name` varchar(25) NOT NULL,
...
/*Data for the table `phphr_resume_training` */

insert  into `phphr_resume_training`(`id`,`uid`,`eid`,`name`,`sdate`,`edate`,`title`,`content`) values (1,2,1,'培瞓中心',1428940800,1441036800,'训方向','训方向'),(2,2,1,'陪瞓心心',229190400,1440086400,'培训方向','培训描述培训描述培训描述培训描述培训描述培训描述培训描述培训描述培训描述培训描述培训描述培训描述');

/*Table structure for table `phphr_resume_work` */

DROP TABLE IF EXISTS `phphr_resume_work`;

CREATE TABLE `phphr_resume_work` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `uid` int(11) NOT NULL,
  `eid` int(11) NOT NULL,
  `name` varchar(25) NOT NULL,
...
/*Data for the table `phphr_resume_work` */

insert  into `phphr_resume_work`(`id`,`uid`,`eid`,`name`,`sdate`,`edate`,`department`,`title`,`content`) values (1,2,1,'单位名称',1438272000,1439481600,'所在部门','这里是担任职位','1.你老板你老板\n2.你老板你老板\n3.你老板你老板'),(2,2,1,'167167',1435852800,1438099200,'所在部门','担任职位','1. 工作内容\n2. 工作内容\n3. 工作内容');

/*Table structure for table `phphr_reward` */

DROP TABLE IF EXISTS `phphr_reward`;

CREATE TABLE `phphr_reward` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
...
/*Data for the table `phphr_reward` */

/*Table structure for table `phphr_reward_class` */

DROP TABLE IF EXISTS `phphr_reward_class`;

CREATE TABLE `phphr_reward_class` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `name` varchar(20) DEFAULT NULL,
  PRIMARY KEY (`id`)
) ENGINE=MyISAM DEFAULT CHARSET=gbk;

/*Data for the table `phphr_reward_class` */

/*Table structure for table `phphr_seo` */

DROP TABLE IF EXISTS `phphr_seo`;

CREATE TABLE `phphr_seo` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
...
/*Data for the table `phphr_special` */

/*Table structure for table `phphr_special_com` */

DROP TABLE IF EXISTS `phphr_special_com`;

CREATE TABLE `phphr_special_com` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
...
/*Data for the table `phphr_special_com` */

/*Table structure for table `phphr_subscribe` */

DROP TABLE IF EXISTS `phphr_subscribe`;

CREATE TABLE `phphr_subscribe` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
...
/*Data for the table `phphr_subscribe` */

/*Table structure for table `phphr_sysmsg` */

DROP TABLE IF EXISTS `phphr_sysmsg`;

CREATE TABLE `phphr_sysmsg` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
...
/*Data for the table `phphr_sysmsg` */

/*Table structure for table `phphr_talent_pool` */

DROP TABLE IF EXISTS `phphr_talent_pool`;

CREATE TABLE `phphr_talent_pool` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `uid` int(11) DEFAULT NULL,
  `eid` int(11) DEFAULT NULL,
  `cuid` int(11) DEFAULT NULL,
...
/*Data for the table `phphr_talent_pool` */

/*Table structure for table `phphr_templates` */

DROP TABLE IF EXISTS `phphr_templates`;

CREATE TABLE `phphr_templates` (
  `id` int(10) NOT NULL AUTO_INCREMENT,
  `name` varchar(200) DEFAULT NULL,
  `title` varchar(255) DEFAULT NULL,
  `content` text,
...
/*Data for the table `phphr_toolbox_doc` */

/*Table structure for table `phphr_user_entrust` */

DROP TABLE IF EXISTS `phphr_user_entrust`;

CREATE TABLE `phphr_user_entrust` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `uid` int(11) DEFAULT NULL,
  `username` varchar(255) DEFAULT NULL,
  `eid` int(11) DEFAULT NULL,
...
/*Data for the table `phphr_user_entrust` */

/*Table structure for table `phphr_user_entrust_record` */

DROP TABLE IF EXISTS `phphr_user_entrust_record`;

CREATE TABLE `phphr_user_entrust_record` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `eid` int(11) DEFAULT NULL,
  `comid` int(11) DEFAULT NULL,
  `jobid` int(11) DEFAULT NULL,
...
/*Data for the table `phphr_user_entrust_record` */

/*Table structure for table `phphr_user_resume` */

DROP TABLE IF EXISTS `phphr_user_resume`;

CREATE TABLE `phphr_user_resume` (
  `id` int(10) NOT NULL AUTO_INCREMENT,
  `uid` int(10) NOT NULL,
  `eid` int(10) NOT NULL,
...
/*Data for the table `phphr_user_resume` */

insert  into `phphr_user_resume`(`id`,`uid`,`eid`,`expect`,`skill`,`work`,`project`,`edu`,`training`,`cert`,`other`) values (1,2,1,1,2,2,2,2,2,2,1);

/*Table structure for table `phphr_userclass` */

DROP TABLE IF EXISTS `phphr_userclass`;

CREATE TABLE `phphr_userclass` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `keyid` int(11) NOT NULL,
  `name` varchar(100) NOT NULL,
...
/*Data for the table `phphr_userid_job` */

/*Table structure for table `phphr_userid_msg` */

DROP TABLE IF EXISTS `phphr_userid_msg`;

CREATE TABLE `phphr_userid_msg` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `uid` int(11) NOT NULL,
...
/*Data for the table `phphr_userid_msg` */

/*Table structure for table `phphr_warning` */

DROP TABLE IF EXISTS `phphr_warning`;

CREATE TABLE `phphr_warning` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `uid` int(11) DEFAULT NULL,
  `type` int(1) DEFAULT NULL,
  `status` int(1) DEFAULT '1',
...
/*Data for the table `phphr_warning` */

/*Table structure for table `phphr_webscan360` */

DROP TABLE IF EXISTS `phphr_webscan360`;

CREATE TABLE `phphr_webscan360` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT,
...
/*Data for the table `phphr_webscan360` */

/*Table structure for table `phphr_website` */

DROP TABLE IF EXISTS `phphr_website`;

CREATE TABLE `phphr_website` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `type` int(11) NOT NULL DEFAULT '0',
...
/*Data for the table `phphr_website` */

/*Table structure for table `phphr_wxlog` */

DROP TABLE IF EXISTS `phphr_wxlog`;

CREATE TABLE `phphr_wxlog` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
...
/*Data for the table `phphr_wxlog` */

/*Table structure for table `phphr_wxnav` */

DROP TABLE IF EXISTS `phphr_wxnav`;

CREATE TABLE `phphr_wxnav` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `name` varchar(100) NOT NULL,
...
/*Data for the table `phphr_zhaopinhui` */

/*Table structure for table `phphr_zhaopinhui_com` */

DROP TABLE IF EXISTS `phphr_zhaopinhui_com`;

CREATE TABLE `phphr_zhaopinhui_com` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `uid` int(11) DEFAULT '0',
...
/*Data for the table `phphr_zhaopinhui_com` */

/*Table structure for table `phphr_zhaopinhui_pic` */

DROP TABLE IF EXISTS `phphr_zhaopinhui_pic`;

CREATE TABLE `phphr_zhaopinhui_pic` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `title` varchar(200) DEFAULT '0',
  `pic` varchar(200) DEFAULT '0',
  `sort` int(11) DEFAULT '0',
...
/*Data for the table `phphr_zhaopinhui_pic` */
