...
insert  into `phphr_adclick`(`id`,`aid`,`uid`,`ip`,`addtime`) values (1,1,0,'192.168.0.50',1438759725),(2,2,0,'192.168.0.77',1438839216),(3,6,0,'192.168.0.50',1438843413),(4,5,2,'192.168.0.44',1440128921),(5,6,0,'192.168.0.77',1442280382),(6,6,2,'192.168.0.44',1442487808);
...
insert  into `phphr_admin_link`(`id`,`link_name`,`link_url`,`img_type`,`pic`,`link_type`,`link_state`,`link_sorting`,`link_time`,`did`,`tem_type`) values (1,'药师多药业系统','http://www.yaoshiduo.com',0,'','1',1,9,'1330695646',0,3),(2,'药师多药业招聘系统','http://www.yaoshiduo.com',0,'','1',1,1,'1330828266',8,2),(3,'药师多系统','http://www.yaoshiduo.com',0,'','1',1,0,'1356609401',8,3),(4,'药师多招聘系统','http://www.yaoshiduo.com',1,'data/upload/link/20140523/14072507114.JPG','2',1,0,'1375926679',0,1);
...
insert  into `phphr_admin_user`(`uid`,`m_id`,`username`,`password`,`name`,`did`,`lasttime`) values (1,1,'admin','21232f297a57a5a743894a0e4a801fc3','超级管理员',0,1442487806);
...
insert  into `phphr_company_statis`(`uid`,`pay`,`integral`,`sq_job`,`fav_job`,`rating`,`rating_name`,`vip_etime`,`all_pay`,`consum_pay`,`rating_type`,`invite_resume`,`comtpl`,`comtpl_all`,`job_num`,`editjob_num`,`breakjob_num`,`down_resume`,`qqshow`,`qqcomment`,`sinashare`,`sinashow`,`sinacomment`,`qqwname`,`sinawname`,`lt_job_num`,`lt_editjob_num`,`lt_breakjob_num`,`lt_down_resume`,`qqshare`,`msg_num`,`autotime`,`vip_stime`,`did`) values (3,0.00,'29',2,0,3,'免费会员','0',0.00,0.00,1,10,'0',NULL,0,1,2,5,0,0,0,0,0,NULL,NULL,0,0,0,0,0,0,0,0,NULL),(14,0.00,'10',1,0,3,'免费会员','0',0.00,0.00,1,10,'0',NULL,3,1,2,5,0,0,0,0,0,NULL,NULL,0,0,0,0,0,0,0,0,NULL);
...
insert  into `phphr_fav_job`(`id`,`uid`,`com_id`,`com_name`,`datetime`,`type`,`job_name`,`job_id`) values (1,2,3,'三全',1442543958,1,'会计',1);
...
insert  into `phphr_friend_foot`(`id`,`uid`,`fid`,`num`,`ctime`) values (1,1,2,2,1442564210);
...
insert  into `phphr_friend_info`(`uid`,`nickname`,`sex`,`pic`,`pic_big`,`description`,`fans`,`atnnum`,`ask`,`answer`,`birthday`,`usertype`,`iscert`,`did`) values (1,'tao',3,NULL,NULL,NULL,0,0,0,0,NULL,1,0,NULL),(2,'test',3,NULL,NULL,NULL,0,0,0,0,NULL,1,0,NULL),(3,'company',3,NULL,NULL,NULL,0,0,0,0,NULL,2,0,NULL),(14,'神华集团',3,NULL,NULL,NULL,0,0,0,0,NULL,2,0,NULL);
...
insert  into `phphr_friend_state`(`id`,`uid`,`content`,`ctime`,`type`,`msg_pic`) values (1,2,'发布了 <a href=\"http://www.phphr.com/resume/index.php?c=show&id=1\" target=\"_blank\">新简历</a>。',1438856998,2,NULL),(2,2,'123123',1440129131,1,NULL);
...
insert  into `phphr_hot_key`(`id`,`key_name`,`num`,`type`,`size`,`check`,`color`,`bold`,`tuijian`,`wxtime`,`wxuser`,`wxid`) values (1,'123',1,3,NULL,0,NULL,NULL,0,0,NULL,'0'),(2,'会计',1,3,NULL,0,NULL,NULL,0,0,NULL,'0'),(3,'三全',12,4,NULL,0,NULL,NULL,0,0,NULL,'0');
...
insert  into `phphr_look_job`(`id`,`uid`,`jobid`,`com_id`,`datetime`,`status`,`com_status`,`did`) values (1,2,1,3,1442563585,0,0,NULL),(2,2,24,5,1442201947,0,0,NULL),(3,2,3,14,1442470024,0,0,NULL),(4,2,2,3,1442563515,0,0,NULL);
...
insert  into `phphr_member_log`(`id`,`uid`,`opera`,`type`,`usertype`,`content`,`ip`,`ctime`) values (1,2,2,1,1,'创建一份简历','192.168.0.44',1438856998),(2,2,7,0,1,'修改基本信息','192.168.0.44',1438858369),(3,2,0,0,1,'上传头像','192.168.0.44',1438858433),(4,2,0,0,1,'发表朋友圈说说','192.168.0.44',1440129131),(5,3,7,0,2,'修改企业信息','192.168.0.50',1441008352),(6,2,6,0,1,'我申请了职位：hr','192.168.0.44',1442458649),(7,2,5,0,1,'收藏了职位：会计','192.168.0.44',1442543959),(8,2,6,0,1,'我申请了职位：会计','192.168.0.44',1442544894),(9,2,6,0,1,'我申请了职位：会计','192.168.0.44',1442562263);
...
insert  into `phphr_member_statis`(`uid`,`integral`,`pay`,`resume_num`,`fav_jobnum`,`sq_jobnum`,`message_num`,`down_num`) values (1,'11',0.00,0,0,0,0,0),(2,'30',0.00,1,1,3,0,0);
...
insert  into `phphr_recycle`(`id`,`username`,`tablename`,`body`,`ctime`) values (1,'admin','q_class','a:7:{s:2:\"id\";s:2:\"45\";s:4:\"name\";s:7:\"iOS应用\";s:3:\"pid\";s:1:\"0\";s:3:\"pic\";s:51:\"data/upload/question_class/20150624/14437796925.JPG\";s:4:\"sort\";s:1:\"0\";s:5:\"intro\";s:30:\"iPhone, iPod Touch, iPad apps.\";s:8:\"add_time\";s:10:\"1374733246\";}',1441941072),(2,'admin','question','N;',1441941072),(3,'admin','answer','N;',1441941072),(4,'admin','answer_review','N;',1441941072);
...
insert  into `phphr_resume_edu`(`id`,`uid`,`eid`,`name`,`sdate`,`edate`,`specialty`,`title`,`content`) values (1,2,1,'学校名称非洲大学',1438531200,1440604800,'计算机','学生','没什么专业可言'),(2,2,1,'昨天大学',1438704000,1440777600,'计算鸡','老师','非常专业');
...
insert  into `phphr_resume_project`(`id`,`uid`,`eid`,`name`,`sdate`,`edate`,`sys`,`title`,`content`) values (1,2,1,'母鸡生蛋',1437926400,1440777600,'环境不好','职位打杂','没有内容没有内容没有内容没有内容没有内容没有内容没有内容没有内容没有内容没有内容没有内容没有内容'),(2,2,1,'不鸟你',1430841600,1441468800,'你老板','你妹','项目内容填写的');
...
insert  into `phphr_userid_job`(`id`,`uid`,`job_id`,`job_name`,`com_id`,`com_name`,`eid`,`datetime`,`type`,`is_browse`,`body`,`did`) values (3,2,1,'会计',3,'三全',1,1442562263,1,1,NULL,NULL);
