...
{
	function resumelist_action()//简历列表
	{
	...
	function resumeshow_action()//简历详情
	{
		if(!$_POST['id'])
		{
	...
	function resumedel_action()//简历删除
	{
		if(!$_POST['ids'])
		{
			$this->return_appadmin_msg(2,"参数出错");
	...
	function certlist_action()//个人认证列表
	{
		$where="`idcard_pic`<>''";
		$page=$_POST['page'];
		$limit=$_POST['limit'];
	...
	function certstatus_action()//认证审核
	{
	...
	function tinylist_action()//微简历列表
	{
		$where="1";
		$page=$_POST['page'];
		$limit=$_POST['limit'];
	...
	function tinystatus_action()//微招聘审核
	{
	...
	function userlist_action()//个人用户列表
	{
		$where="a.uid=b.uid";
		$page=$_POST['page'];
		$limit=$_POST['limit'];
	...
	function userdel_action()//个人用户删除
	{
		if(!$_POST['uids'])
		{
			$this->return_appadmin_msg(2,"参数出错");
