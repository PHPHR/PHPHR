...
{
	function moblielist_action()//短信记录列表
	{
		$where="1";
		$page=$_POST['page'];
		$limit=$_POST['limit'];
	...
	function mobliedel_action()//短信记录删除
	{
		if(!$_POST['ids'])
		{
	...
	function emaillist_action()//邮件记录列表
	{
		$where="1";
		$page=$_POST['page'];
		$limit=$_POST['limit'];
	...
	function emaildel_action()//邮件记录删除
	{
		if(!$_POST['ids'])
		{
			$this->return_appadmin_msg(2,"参数出错");
	...
	function messagelist_action()//留言反馈列表
	{
		$where="1";
		$page=$_POST['page'];
		$limit=$_POST['limit'];
	...
	function messagedel_action()//留言反馈删除
	{
		if(!$_POST['ids'])
		{
			$this->return_appadmin_msg(2,"参数出错");
