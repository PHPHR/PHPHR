...
function gpc2sql($str,$str2) {
	...
	$arr=array("sleep"=>"Ｓleep"," and "=>" an d "," or "=>" Ｏr ","%20"=>" ","select"=>"Ｓelect","update"=>"Ｕpdate","count"=>"Ｃount","chr"=>"Ｃhr","truncate"=>"Ｔruncate","delete"=>"Ｄelete","insert"=>"Ｉnsert","<"=>"&lt;",">"=>"&gt;","\""=>"&quot;","'"=>"&acute;","--"=>"- -","\("=>"（","\)"=>"）","00000000"=>"OOOOOOOO");
